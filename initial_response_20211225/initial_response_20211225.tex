...
\textbf{Response.} 
There is no $M_0$ in Page 6 row 43.
...
\rcomment{
Figure 5. In the caption you write that this I a process of "merging events for a step". In the bottom of figure 5 it is stated "all the steps".
}
\textbf{Response.}
No. We will explain blocked areas and free areas earlier.
