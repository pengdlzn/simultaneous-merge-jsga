...
To prolong the smooth changes so that they are observable, 
...
When a user browses our web map, 
...
\sects\ref{sec:greedy_algo}, \ref{sec:integrate_ssc}, and \ref{sec:integrate_tgap} 
...
otherwise, the map will stay the same if the map user zooms only a little bit.
} 
